...
// دوال الألوان من theme.cpp (extern "C" ولا نلمس struct Theme)
extern "C" {
...
void android_main(struct android_app* app) {
    log_to_file("android_main start");
